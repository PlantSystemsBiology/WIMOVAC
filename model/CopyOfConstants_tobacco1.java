...
public class CopyOfConstants_tobacco1 {
	/*
	...
	static public double SolarConstant                 			= 2600;
    ...
    static public double Atmospheric_Pressure_sea_level         = 101.324;
    ...
    static public double AnnualMeanAirTemperature       			= 10;
    ...
    static public double KarmansConstant        					= 0.41;
    ...
    static public double SpecificHeatCapacityAir        			= 1010;
    ...
    static public double StefanBoltzmanConst        				= 5.67E-8;
    ...
    static public double Vcmaxo							= 66;  //90
    ...
    static public int RespirationCalculationMethod      = 1;    // QF set 1, use respiration
    ...
    static public double ComponentOfOrgans[][] = { 
    	//leaf stem s_root f_root storage pot seed
    ...
    static public double RelPartition[][] = {  // parameters from Guiyang Measurement in 2011-2012. QF, 2013.
    //   leaf       stem    root   non non flower	 non
    	{0.766, 	0.160, 	0.074,  0, 0,    0,       0},
    	{0.766, 	0.160, 	0.074,  0, 0,    0,       0},
    	{0.766, 	0.160, 	0.074,  0, 0,    0,       0},
    	{0.716, 	0.162, 	0.122,  0, 0,    0,       0},
    	{0.716, 	0.162, 	0.122,  0, 0,    0,       0}, 
    	{0.629, 	0.185, 	0.186,  0, 0,    0,       0},
    	{0.629, 	0.185, 	0.186,  0, 0,    0,       0},
    	{0.629, 	0.185, 	0.186,  0, 0,    0,       0},
    	{0.386, 	0.294, 	0.320,  0, 0,    0,       0}, 
    	{0.386, 	0.294, 	0.320,  0, 0,    0,       0},
    	{0.386, 	0.294, 	0.320,  0, 0,    0,       0},
    	{0.474, 	0.312, 	0.214,  0, 0,    0,       0}, 
    	{0.474, 	0.312, 	0.214,  0, 0,    0,       0}, 
    	{0.474, 	0.312, 	0.214,  0, 0,    0,       0}, 
    	{0.383, 	0.278, 	0.248,  0, 0,    0.091,   0},
    };
    
    
    static public double RelPartition_default[][]    	= { 
...
//    static public double PartitionActual[][]    = new double[14][7]; 	//QF, actual partitioning coefficients of 14 stages for 7 organs, calcualted from RelPartition and modifier
	...
	static public int PartitioningModelSwitch = 2;                          // 0: do not growth, 1: only leaf growth, 2: 
    ...
    static public int GrowthModelSwitch                             = 1; //germination 
}
